...
function CustomTextField(props: iTextField) {
    ...
    if (props.naked) {
        return <InputBase value={props.value} required={props.required} type={props.password ? "password" : "text"} placeholder={props.placeholder} onChange={_onChange} multiline={props.multiline} rows={props.rows} fullWidth={props.fullwidth} />
    }
    ...
    return (
        <TextFieldCore InputProps={{required: props.required}} error={error} disabled={props.disabled} InputLabelProps={{shrink: props.fixedLabel}} variant={props.variant} label={props.label} value={props.value} type={props.password ? "password" : "text"} placeholder={props.placeholder} onChange={_onChange} multiline={props.multiline} rows={props.rows} fullWidth={props.fullwidth} />
    )
}
